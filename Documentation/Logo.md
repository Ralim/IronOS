...
Please note: logo support has been added with [V2.22](History.md#pinecilv2-notes). If your Pinecil V2 runs a previous firmware (find out by holding (-)), make sure to upgrade to a newer version first.
