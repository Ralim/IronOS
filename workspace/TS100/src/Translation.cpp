...
const char* SettingsDescriptions[] = {
    ...
    /* AutoStart                 */
    "Automatically starts the iron into soldering on power up. T=Soldering, S= "
    "Sleep mode,F=Off",
    /* CooldownBlink             */
    ...
    "typically smaller in other systems",
#endif
#ifdef PIDSETTINGS
    /* PidSettingsI              */
    "PID I term. Inverse values! This acts as a divisor. So Larger numbers == "
    "typically smaller in other systems",
#endif
#ifdef PIDSETTINGS
    /* PidSettingsD              */
    "PID D term. Inverse values! This acts as a divisor. So Larger numbers == "
    "typically smaller in other systems",
#endif
};
...
const char* SettingsDescriptions[] = {
    ...
    /* SleepTimeout              */
    "Включване в режим \"сън\" след: <Минути/Секунди>",
    /* ShutdownTimeout           */ "Изключване след <Минути>",
    /* MotionSensitivity         */
    "Усещане за движение <0.Изключено 1.Слабо 9.Силно>",
    /* TemperatureUnit           */
    "Единици за температура <C=Целзии F=Фаренхайт>",
    /* AdvancedIdle              */
    "Покажи детайлна информация със ситен шрифт на екрана в режим на покой.",
    /* DisplayRotation           */
    "Ориентация на дисплея <A. Автоматично L. Лява Ръка R. Дясна Ръка>",
    /* BoostEnabled              */
    "Ползвай предния бутон за \"турбо\" режим с температура до 450C при "
    "запояване",
    /* BoostTemperature          */ "Температура за \"турбо\" режим",
    /* AutoStart                 */
    "Режим на поялника при включване на захранването. T=Работен, S=Сън, "
    "F=Изключен",
    /* CooldownBlink             */
    "След изключване от работен режим, индикатора за температура да мига "
    "докато човката на поялника все още е топла",
    /* TemperatureCalibration    */ "Калибриране на температурата",
    /* SettingsReset             */ "Връщане на фабрични настройки",
    /* VoltageCalibration        */
    "Калибриране на входното напрежение (VIN). Задръжте бутонa за изход",
    /* AdvancedSoldering         */
    "Детайлна информация в работен режим при запояване",
...
const char* SettingsCalibrationWarning =
    "Уверете се, че човката на поялника е със стайна температура преди да "
    "продължите!";
const char* SettingsResetWarning =
    "Сигурни ли сте, че искате да върнете фабричните настройки?";
...
const char* SettingsDescriptions[] = {
    /* PowerSource               */
    "Při nižším napětí ukončí pájení <DC=10V, ?S=?x3.3V pro LiPo,LiIon...>",
    ...
    /* MotionSensitivity         */
    "Citlivost detekce pohybu <0=Vyp, 1=Min, ... 9=Max>",
    /* TemperatureUnit           */
    "Jednotky měření teploty <C=Celsius, F=Fahrenheit>",
    /* AdvancedIdle              */
    "Zobrazit podrobnosti na výchozí obrazovce?",
    /* DisplayRotation           */
    "Orientace obrazovky <A=Auto, L=Levák, P=Pravák>",
    /* BoostEnabled              */
    "Povolit boost držením předního tlačítka při pájení?",
    /* BoostTemperature          */ "Teplota v režimu boost.",
    /* AutoStart                 */ "Při startu ihned nahřát hrot?",
    /* CooldownBlink             */
    "Blikání teploty při chladnutí, dokud je hrot horký?",
    /* TemperatureCalibration    */ "Kalibrace měření teploty.",
    /* SettingsReset             */ "Obnovení továrního nastavení.",
    /* VoltageCalibration        */
    "Kalibrace vstupního napětí. Tlačítky uprav, podržením potvrď.",
    /* AdvancedSoldering         */ "Zobrazit podrobnosti při pájení?",
    /* ScrollingSpeed            */
    "Rychlost skrolování popisků podobných tomuto <P=Pomalu,R=Rychle>",
#ifdef PIDSETTINGS
    /* PidSettingsP              */
    "PID P term. Inverse values! This acts as a divisor. So Larger numbers == "
    "typically smaller in other systems",
...
const char* SettingsCalibrationWarning =
    "Ujistěte se, že hrot má pokojovou teplotu!";
const char* SettingsResetWarning =
    "Opravdu chcete resetovat zařízení do továrního nastavení?";
const char* UVLOWarningString = "DC LOW";
...
const char* SettingsDescriptions[] = {
    ...
    /* AdvancedIdle              */
    "Detaillierte Anzeige im Ruhemodus <J=An, N=Aus>",
    /* DisplayRotation           */
    "Ausrichtung der Anzeige <A=Automatisch, L=Linkshändig, R=Rechtshändig>",
    /* BoostEnabled              */
    "Vordere Taste für Temperaturboost verwenden <J=An, N=Aus>",
    /* BoostTemperature          */
    "Temperatur im Boostmodus  (In der eingestellten Einheit)",
    /* AutoStart                 */
    "Automatischer Start des Lötmodus beim Einschalten der "
    "Spannungsversorgung. <J=An, N=Aus>",
    /* CooldownBlink             */
    "Blinkende Temperaturanzeige beim Abkühlen, solange heiß. <J=An, N=Aus>",
    /* TemperatureCalibration    */ "Kalibrierung der Lötspitzentemperatur",
    /* SettingsReset             */ "Alle Einstellungen zurücksetzen",
    /* VoltageCalibration        */
    "Kalibrierung der Eingangsspannung. Kurzer Tastendruck zum Einstellen, "
    "langer Tastendruck zum Verlassen.",
    /* AdvancedSoldering         */
    "Detaillierte Anzeige im Lötmodus <J=An, N=Aus>",
...
const char* SettingsDescriptions[] = {
    ...
    "tilstand,S=Slukket",
    /* CooldownBlink             */
    "Blink temperaturen på skærmen, mens spidsen stadig er varm.",
    /* TemperatureCalibration    */ "kalibrere spids temperatur.",
    /* SettingsReset             */ "Gendan alle indstillinger",
    /* VoltageCalibration        */
    "VIN kalibrering. Knapperne justere, Lang tryk for at gå ud",
    /* AdvancedSoldering         */
    "Vis detialieret information mens der loddes",
    /* ScrollingSpeed            */ "Speed this text scrolls past at",
#ifdef PIDSETTINGS
    /* PidSettingsP              */
    "PID P term. Inverse values! This acts as a divisor. So Larger numbers == "
...
const char* SettingsDescriptions[] = {
    /* PowerSource               */
    "Fuente de energía. Ajusta el límite inferior de voltaje. <DC=10V S=3.3V "
    "por celda>",
    ...
    /* MotionSensitivity         */
    "Sensibilidad del movimiento. <0=Apagado 1=El menos sensible 9=El más "
    "sensible>",
    /* TemperatureUnit           */ "Unidad de temperatura.",
    /* AdvancedIdle              */
    "Muestra información detallada pequena en la pantalla inactiva.",
    /* DisplayRotation           */
    ...
    /* VoltageCalibration        */
    "Calibración VIN (Voltaje de entrada). Ajuste con ambos botones, pulsación "
    "larga para salir.",
    /* AdvancedSoldering         */
    "Mostrar información detallada mientras suelda.",
...
const char* SettingsResetWarning =
    "¿Está seguro de volver a estado de fábrica?";
...
const char* SettingsDescriptions[] = {
    /* PowerSource               */
    "Käytettävä virtalähde. Asettaa katkaisujänniteen. <DC 10V, 3S=9.9V, "
    "4S=13.2V, 5S=16.5V, 6S=19.8V>",
    /* SleepTemperature          */ "Lepotilan lämpötila. <C>",
    /* SleepTimeout              */ "Lepotilan viive. <minuuttia/sekuntia>",
    /* ShutdownTimeout           */
    "Automaattisen sammutuksen aikaviive. <minuuttia>",
    /* MotionSensitivity         */
    "Liikkeentunnistuksen herkkyys. <0=pois, 1=epäherkin, 9=herkin>",
    /* TemperatureUnit           */
    "Lämpötilan yksikkö. <C=celsius, F=fahrenheit>",
    /* AdvancedIdle              */
    "Näyttää yksityiskohtaisemmat tiedot lepotilassa.",
    /* DisplayRotation           */
    "Näytön kierto. <A=automaattinen O=oikeakätinen V=vasenkätinen>",
    /* BoostEnabled              */
    "Etupainikeella siirrytään juotettaessa tehostustilaan.",
    /* BoostTemperature          */ "Tehostustilan lämpötila",
    /* AutoStart                 */
    "Käynnistää virrat kytkettäessä juotostilan automaattisesti. T=juotostila, "
    "S=Lepotila, F=Ei käytössä",
    /* CooldownBlink             */
    "Vilkuttaa jäähtyessä juotoskärjen lämpötilaa sen ollessa vielä "
    "vaarallisen kuuma.",
    /* TemperatureCalibration    */ "Kalibroi kärjen lämpötilaeron.",
    /* SettingsReset             */ "Palauta kaikki asetukset oletusarvoihin.",
    /* VoltageCalibration        */
    "Tulojännitten kalibrointi (VIN). Painikkeilla säädetään ja pitkään "
    "painamalla poistutaan.",
    /* AdvancedSoldering         */
    "Näyttää yksityiskohtaisemmat tiedot juotostilassa.",
    /* ScrollingSpeed            */ "Näiden selitetekstien vieritysnopeus.",
};

const char* SettingsCalibrationWarning =
    "Varmista että kärki on huoneenlämpöinen ennen jatkamista!";
...
const char* SettingsDescriptions[] = {
    /* PowerSource               */
    "Source d'alimentation. Règle la tension de coupure <DC=10V S=3.3V par "
    "cellules>",
    ...
    /* MotionSensitivity         */
    "Sensibilité du capteur de mouvement <0=Inactif 1=Peu sensible 9=Tres "
    "sensible>",
    /* TemperatureUnit           */
    "Unité de température <C=Celsius F=Fahrenheit>",
    /* AdvancedIdle              */
    "Afficher des informations détaillées lors de la veille.",
    /* DisplayRotation           */
    "Orientation de l'affichage <A=Automatique G=Gaucher D=Droitier>",
    /* BoostEnabled              */
    "Activer le mode \"Boost\" en maintenant le bouton de devant pendant la "
    "soudure",
    /* BoostTemperature          */ "Température du mode \"Boost\"",
    /* AutoStart                 */
    "Démarrer automatiquement la soudure a l'allumage <A=Activé, V=Mode "
    "Veille, D=Désactivé>",
    /* CooldownBlink             */
    "Faire clignoter la température lors du refroidissement tant que la panne "
    "est chaude.",
    /* TemperatureCalibration    */ "Etalonner température de la panne.",
    /* SettingsReset             */ "Réinitialiser tous les réglages",
    /* VoltageCalibration        */
    "Etalonner tension d'entrée. Boutons pour ajuster, appui long pour quitter",
    /* AdvancedSoldering         */
    "Afficher des informations détaillées pendant la soudure",
    /* ScrollingSpeed            */
    "Vitesse de défilement de ce texte en <R=Rapide L=Lent>",
};
...
const char* SettingsDescriptions[] = {
    /* PowerSource               */
    "Izvor napajanja. Postavlja napon isključivanja. <DC 10V> <S 3.3V po "
    "ćeliji>",
    /* SleepTemperature          */
    "Temperatura na koju se spušta lemilica nakon određenog vremena mirovanja. "
    "<C/F>",
    /* SleepTimeout              */
    "Vrijeme mirovanja nakon kojega lemilica spušta temperaturu. "
    "<Minute/Sekunde>",
    /* ShutdownTimeout           */
    "Vrijeme mirovanja nakon kojega će se lemilica ugasiti. <Minute>",
    /* MotionSensitivity         */
    "Osjetljivost prepoznavanja pokreta. <0=Ugašeno, 1=Najmanje osjetljivo, "
    "9=Najosjetljivije>",
    /* TemperatureUnit           */
    "Jedinica temperature. <C=Celzij, F=Fahrenheit>",
    /* AdvancedIdle              */
    "Prikazivanje detaljnih informacija tijekom čekanja.",
    /* DisplayRotation           */
    "Orijentacija ekrana. <A=Automatski, L=Ljevoruki, D=Desnoruki>",
    /* BoostEnabled              */
    "Držanjem prednjeg gumba prilikom lemljenja aktivira se pojačani (Boost) "
    "način.",
    /* BoostTemperature          */ "Temperatura u pojačanom (Boost) načinu.",
    /* AutoStart                 */
    "Ako je aktivno, lemilica po uključivanju napajanja odmah počinje grijati.",
    /* CooldownBlink             */
    "Bljeskanje temperature prilikom hlađenja, ako je lemilica vruća.",
    /* TemperatureCalibration    */
    "Kalibriranje temperature mjeri razliku temperatura vrška i drške, dok je "
    "lemilica hladna.",
    /* SettingsReset             */
    "Vraćanje svih postavki na tvorničke vrijednosti.",
    /* VoltageCalibration        */
    "Kalibracija ulaznog napona. Podešavanje gumbima, dugački pritisak za "
    "kraj.",
    /* AdvancedSoldering         */
    "Prikazivanje detaljnih informacija tijekom lemljenja.",
    /* ScrollingSpeed            */
    "Brzina kretanja dugačkih poruka. <B=brzo, S=sporo>",
};
...
const char* SettingsCalibrationWarning =
    ...
    "nastavite!";
const char* SettingsResetWarning =
    "Jeste li sigurni da želite sve postavke vratiti na tvorničke vrijednosti?";
...
const char* SettingsDescriptions[] = {
    ...
    /* MotionSensitivity         */
    "Mozgás érzékenység beállítása. <0.Ki 1.kevésbé érzékeny 9.legérzékenyebb>",
    /* TemperatureUnit           */
    "Hőmérsékleti egység <C=Celsius F=Fahrenheit>",
    /* AdvancedIdle              */
    "Részletes információ megjelenítése kisebb betűméretben a készenléti "
    "képernyőn.",
    /* DisplayRotation           */
    "Megjelenítési tájolás <A. Automatikus L. Balkezes R. Jobbkezes>",
    /* BoostEnabled              */
    "Elülső gombbal lépjen boost módba, 450C forrasztás közben",
    /* BoostTemperature          */ "Hőmérséklet \"boost\" módban",
    /* AutoStart                 */
    "Bekapcsolás után automatikusan lépjen forrasztás módba. T=Forrasztás, "
    "S=Alvó mód,F=Ki",
    /* CooldownBlink             */
    "Villogjon a hőmérséklet hűlés közben, amíg a hegy forró.",
    /* TemperatureCalibration    */ "Hegy hőmérsékletének kalibrálása",
    /* SettingsReset             */ "Beállítások alaphelyzetbe állítása",
    /* VoltageCalibration        */
    "A bemeneti feszültség kalibrálása. Röviden megnyomva állítsa be, hosszan "
    "nyomja meg a kilépéshez.",
    /* AdvancedSoldering         */
    "Részletes információk megjelenítése forrasztás közben",
...
const char* SettingsResetWarning =
    "Biztosan visszaállítja a beállításokat az alapértelmezett értékekre?";
const char* UVLOWarningString = "DC LOW";
const char* UndervoltageString = "Undervoltage";
const char* InputVoltageString = "Input V: ";
const char* WarningTipTempString = "Tip Temp: ";
...
const char* SettingsDescriptions[] = {
    /* PowerSource               */
    "Scegli la sorgente di alimentazione; se a batteria, limita lo "
    "scaricamento al valore di soglia <DC: 10V; S: 3.3V per cella>",
    /* SleepTemperature          */
    "Imposta la temperatura da mantenere in modalità Standby <°C/°F>",
    /* SleepTimeout              */
    "Imposta il timer per entrare in modalità Standby <minuti/secondi>",
    /* ShutdownTimeout           */
    "Imposta il timer per lo spegnimento <minuti>",
    /* MotionSensitivity         */
    "Imposta la sensibilità al movimento per uscire dalla modalità Standby <0: "
    "nessuna; 1: minima; 9: massima>",
    /* TemperatureUnit           */
    "Scegli l'unità di misura per la temperatura <C: grado Celsius; F: grado "
    "Farenheit>",
    /* AdvancedIdle              */
    "Mostra informazioni dettagliate con un carattere più piccolo all'interno "
    "della schermata principale",
    /* DisplayRotation           */
    "Imposta l'orientamento del display <A: automatico; S: mano sinistra; D: "
    "mano destra>",
    /* BoostEnabled              */
    "Il tasto superiore attiva la funzione «Turbo» durante la modalità "
    "Saldatura",
    /* BoostTemperature          */
    "Imposta la temperatura della funzione «Turbo»",
    /* AutoStart                 */
    "Attiva automaticamente il saldatore quando viene alimentato <A: "
    "saldatura; S: standby; D: disattiva>",
    /* CooldownBlink             */
    "Mostra la temperatura durante il raffreddamento se la punta è ancora "
    "calda",
    /* TemperatureCalibration    */ "Calibra le rilevazioni di temperatura",
    /* SettingsReset             */ "Ripristina tutte le impostazioni",
    /* VoltageCalibration        */
    "Calibra la tensione in ingresso; regola con entrambi i tasti, tieni "
    "premuto il tasto superiore per uscire",
    /* AdvancedSoldering         */
    "Mostra informazioni dettagliate durante la modalità Saldatura",
    /* ScrollingSpeed            */
    "Imposta la velocità di scorrimento del testo <L: lento; V: veloce>",
};
...
const char* SettingsDescriptions[] = {
    /* PowerSource               */
    "Išjungimo įtampa. <DC 10V arba celių (S) kiekis (3.3V per celę)>",
    /* SleepTemperature          */ "Miego temperatūra <C>",
    /* SleepTimeout              */ "Miego laikas <minutės/sekundės>",
    /* ShutdownTimeout           */ "Išjungimo laikas <minutės>",
    /* MotionSensitivity         */
    "Jautrumas judesiui <0 - išjungta, 1 - mažiausias, 9 - didžiausias>",
    /* TemperatureUnit           */
    "Temperatūros vienetai <C - Celsijus, F - Farenheitas>",
    /* AdvancedIdle              */
    "Ar rodyti papildomą informaciją mažesniu šriftu laukimo ekrane",
    /* DisplayRotation           */
    "Ekrano orientacija <A - automatinė, K - kairiarankiams, D - "
    "dešiniarankiams>",
    /* BoostEnabled              */
    "Ar lituojant viršutinis mygtukas įjungia turbo režimą",
    /* BoostTemperature          */ "Temperatūra turbo režimu",
    /* AutoStart                 */
    "Ar pradėti kaitininti iš karto įjungus lituoklį",
    /* CooldownBlink             */
    ...
    /* VoltageCalibration        */
    "Įvesties įtampos kalibravimas. Trumpai paspauskite, norėdami nustatyti, "
    "ilgai paspauskite, kad išeitumėte",
    /* AdvancedSoldering         */ "Ar rodyti išsamią informaciją lituojant",
    /* ScrollingSpeed            */ "Greitis, kuriuo šis tekstas slenka",
};

const char* SettingsCalibrationWarning =
    "Prieš tęsdami įsitikinkite, kad antgalis yra kambario temperatūros!";
const char* SettingsResetWarning =
    "Ar norite atstatyti nustatymus į numatytas reikšmes?";
...
const char* SettingsDescriptions[] = {
    /* PowerSource               */
    "Spanningsbron. Stelt drempelspanning in. <DC 10V> <S 3.3V per cel>",
    ...
    /* MotionSensitivity         */
    "Bewegingsgevoeligheid <0.uit 1.minst gevoelig 9.meest gevoelig>",
    /* TemperatureUnit           */
    "Temperatuureenheid <C=Celsius F=Fahrenheit>",
    /* AdvancedIdle              */
    "Gedetailleerde informatie weergeven in een kleiner lettertype op het "
    "slaapscherm.",
    /* DisplayRotation           */
    "Schermoriëntatie <A. Automatisch L. Linkshandig R. Rechtshandig>",
    /* BoostEnabled              */
    "Soldeerbout gaat naar een hogere boost-temperatuur wanneer de voorste "
    "knop ingedrukt is.",
    /* BoostTemperature          */ "Temperatuur in boostmodes",
    /* AutoStart                 */
    "Breng de soldeerbout direct op temperatuur bij het opstarten. "
    "T=Soldeertemperatuur, S=Slaapstand-temperatuur, F=Uit",
    /* CooldownBlink             */
    "Temperatuur laten flikkeren in het hoofdmenu als de soldeerpunt aan het "
    "afkoelen is.",
    /* TemperatureCalibration    */
    "Temperatuursafwijking van de soldeerpunt calibreren.",
    /* SettingsReset             */ "Alle instellingen terugzetten.",
    /* VoltageCalibration        */
    "VIN Calibreren. Knoppen lang ingedrukt houden om te bevestigen.",
    /* AdvancedSoldering         */
    "Gedetailleerde informatie weergeven in een kleiner lettertype op het "
    "soldeerscherm.",
...
const char* SettingsCalibrationWarning =
    "Zorg ervoor dat de soldeerpunt op kamertemperatuur is voor je verdergaat!";
const char* SettingsResetWarning =
    "Ben je zeker dat je alle instellingen naar de standaardwaardes wilt "
    "terugzetten?";
...
const char* SettingsDescriptions[] = {
    /* PowerSource               */
    "Strømforsyning. Sett nedre spenning for automatisk nedstenging. <DC 10V "
    "<S 3.3V per celle",
    ...
    /* MotionSensitivity         */
    "Bevegelsesfølsomhet <0.Inaktiv 1.Minst følsom 9.Mest følsom",
    /* TemperatureUnit           */ "Temperaturskala <C=Celsius F=Fahrenheit",
    /* AdvancedIdle              */
    "Vis detaljert informasjon med liten skrift på dvaleskjermen.",
    /* DisplayRotation           */
    "Skjermretning <A. Automatisk V. Venstrehendt H. Høyrehendt",
    /* BoostEnabled              */
    "Frontknappen aktiverer kraftfunksjonen, 450C ved lodding",
    /* BoostTemperature          */ "Temperatur i \"kraft\"-modus",
    /* AutoStart                 */
    "Start automatisk med lodding når strøm kobles til. L=Lodding, D=Dvale, "
    "I=Inaktiv",
    /* CooldownBlink             */
    "Blink temperaturen på skjermen mens spissen fortsatt er varm.",
...
const char* SettingsResetWarning =
    "Er du sikker på at du vil tilbakestille til standardinnstillinger?";
...
const char* SettingsDescriptions[] = {
    /* PowerSource               */
    "Źródło zasilania. Ustaw napięcie odcięcia. <DC 10V> <S 3.3V dla ogniw Li>",
    /* SleepTemperature          */ "Temperatura uśpienia <°C>",
    /* SleepTimeout              */ "Czas uśpienia <Minuty/Sekundy>",
    /* ShutdownTimeout           */ "Czas wyłączenia <Minuty>",
    /* MotionSensitivity         */
    "Czułość ruchu <0.Wyłączona 1.minimalna 9.maksymalna>",
    /* TemperatureUnit           */
    "Jednostka temperatury <C=Celsius F=Fahrenheit>",
    /* AdvancedIdle              */
    "Wyświetla szczegółowe informacje za pomocą mniejszej czcionki na ekranie "
    "bezczynnośći <T = wł., N = wył.>",
    /* DisplayRotation           */
    "Orientacja wyświetlacza <A. Automatyczna L. Leworęczna P. Praworęczna>",
    /* BoostEnabled              */
    "Użyj przycisku przedniego w celu zwiększenia temperatury <T = wł., N = "
    "wył.>",
    /* BoostTemperature          */ "Temperatura w trybie \"boost\" ",
    /* AutoStart                 */
    "Automatyczne uruchamianie trybu lutowania po włączeniu zasilania. "
    "T=Lutowanie, S= Tryb Uspienia ,N=Wyłącz",
    /* CooldownBlink             */
    "Temperatura na ekranie miga, gdy grot jest jeszcze gorący. <T = wł., N = "
    "wył.>",
    /* TemperatureCalibration    */ "Kalibracja temperatury grota lutownicy",
    /* SettingsReset             */ "Zresetuj wszystkie ustawienia",
    /* VoltageCalibration        */
    "Kalibracja napięcia wejściowego. Krótkie naciśnięcie, aby ustawić, długie "
    "naciśnięcie, aby wyjść.",
    /* AdvancedSoldering         */
    "Wyświetl szczegółowe informacje podczas lutowania <T = wł., N = wył.>",
    /* ScrollingSpeed            */ "Speed this text scrolls past at",
};
...
const char* SettingsDescriptions[] = {
    /* PowerSource               */
    "nte de alimentação. Define a tensão de corte. <DC=10V> <S=3.3V/célula>",
    ...
    /* MotionSensitivity         */
    "Sensibilidade ao movimento <0=Desligado 1=Menor 9=Maior>",
    /* TemperatureUnit           */
    "Unidade de temperatura <C=Celsius F=Fahrenheit>",
    /* AdvancedIdle              */ "Exibe informações avançadas quando ocioso",
    /* DisplayRotation           */
    "Orientação da tela <A.utomática C.anhoto D.estro>",
    ...
    /* CooldownBlink             */
    "Faz o valor da temperatura piscar durante o resfriamento",
    /* TemperatureCalibration    */ "Calibra a temperatura",
    /* SettingsReset             */ "Reverte todos ajustes",
    /* VoltageCalibration        */
    "Calibra a tensão de alimentação. Use os botões para ajustar o valor. "
    "Mantenha presionado para sair",
    /* AdvancedSoldering         */ "Exibe informações avançadas durante o uso",
    /* ScrollingSpeed            */ "Velocidade que esse texto é exibido",
};

const char* SettingsCalibrationWarning =
    "A ponta deve estar em temperatura ambiente antes de continuar!";
...
const char* SettingsDescriptions[] = {
    /* PowerSource               */
    "Источник питания. Установка напряжения отключения. <DC 10V> <S 3.3 V на "
    "батарею>",
    /* SleepTemperature          */ "Температура режима ожидания <С>",
    /* SleepTimeout              */
    "Время до перехода в режим ожидания <Минуты>",
    ...
    /* AdvancedIdle              */
    "Показывать детальную информацию маленьким шрифтом на домашнем экране",
    /* DisplayRotation           */
    "Ориентация дисплея <A. Автоматический, Л. Левая рука, П. Правая рука>",
    /* BoostEnabled              */
    "Турбо-режим при удержании кнопки А при пайке ",
    /* BoostTemperature          */ "Температура в турбо-режиме",
    /* AutoStart                 */
    "Автоматический запуск паяльника при включении питания. T=Нагрев, S=Режим "
    "ожидания,F=Выкл.",
    /* CooldownBlink             */
    "Показывать температуру на экране охлаждения, пока жало остается горячим.",
    /* TemperatureCalibration    */ "Калибровка термодатчика.",
    /* SettingsReset             */ "Сброс всех настроек.",
    /* VoltageCalibration        */
    "Калибровка напряжения входа. Настройка кнопками, нажать и удержать чтобы "
    "завершить.",
    /* AdvancedSoldering         */
    "Показывать детальную информацию при пайке.",
...
const char* SettingsCalibrationWarning =
    ...
    "продолжать!";
const char* SettingsResetWarning =
    "Вы действительно хотите сбросить настройки до значений по умолчанию?";
...
const char* SettingsDescriptions[] = {
    /* PowerSource               */
    "Zdroj napatia. Nastavit napatie pre vypnutie (cutoff)  <DC=10V, nS=n*3.3V "
    "pre LiIon clanky>",
    /* SleepTemperature          */
    ...
    /* AdvancedIdle              */
    "Zobrazit detailne informacie v kludovom rezime <T=Zap, F=Vyp>",
    /* DisplayRotation           */
    ...
    /* VoltageCalibration        */
    "Kalibracia VIN. Kratke stlacenie meni nastavenie, dlhe stlacenie pre "
    "navrat",
    /* AdvancedSoldering         */
    "Zobrazenie detailov pocas spajkovania <T=Zap, F=Vyp>",
    /* ScrollingSpeed            */ "Speed this text scrolls past at",
};
...
const char* SettingsDescriptions[] = {
    ...
    "<C/F>",
    /* SleepTimeout              */
    "Vreme mirovanja nakon koga lemilica spušta temperaturu. <Minute/Sekunde>",
    /* ShutdownTimeout           */
    "Vreme mirovanja nakon koga će se lemilica ugasiti.",
    /* MotionSensitivity         */
    "Osetljivost prepoznavanja pokreta. <0=Ugašeno, 1=Najmanje osetljivo, "
    "9=Najosjetljivije>",
    /* TemperatureUnit           */
    "Jedinica temperature. <C=Celzijus, F=Fahrenheit>",
    /* AdvancedIdle              */
    "Prikazivanje detaljnih informacija manjim fontom tokom čekanja.",
    /* DisplayRotation           */
    "Orijentacija ekrana. <A=Automatski, L=Levoruki, D=Desnoruki>",
    /* BoostEnabled              */
    "Držanjem prednjeg dugmeta prilikom lemljenja aktivira se pojačani (Boost) "
    "način.",
    /* BoostTemperature          */ "Temperatura u pojačanom (Boost) načinu.",
    /* AutoStart                 */
    "Ako je aktivno, lemilica po uključivanju napajanja odmah počinje grejati.",
    /* CooldownBlink             */
    "Blinkanje temperature prilikom hlađenja, ako je lemilica vruća.",
    /* TemperatureCalibration    */
    "Kalibrisanje temperature meri razliku temperatura vrha i drške, dok je "
    "lemilica hladna.",
    /* SettingsReset             */
    "Vraćanje svih podešavanja na fabričke vrednosti.",
    /* VoltageCalibration        */
    "Kalibracija ulaznog napona. Podešavanje tastera, dugački pritisak za "
    "kraj.",
    /* AdvancedSoldering         */
    "Prikazivanje detaljnih informacija tokom lemljenja.",
    /* ScrollingSpeed            */
    "Brzina kretanja dugačkih poruka <B=brzo, S=sporo>",
};

const char* SettingsCalibrationWarning =
    "Proverite da li je vrh ohlađen na sobnu temperaturu pre nego što "
    "nastavite!";
const char* SettingsResetWarning =
    "Jeste li sigurni da želite da vratite sva podešavanja na fabričke "
    "vrednosti?";
const char* UVLOWarningString = "BATERIJA";
const char* UndervoltageString = "PRENIZAK NAPON";
const char* InputVoltageString = "Napajanje: ";
...
const char* SettingsDescriptions[] = {
    ...
    /* MotionSensitivity         */
    "Rörelsekänslighet <0.Av 1.minst känslig 9.mest känslig>",
    /* TemperatureUnit           */ "Temperaturenhet <C=Celsius F=Fahrenheit>",
    /* AdvancedIdle              */
    "Visa detaljerad information i mindre typsnitt när inaktiv.",
    /* DisplayRotation           */
    "Visningsläge <A. Automatisk V. Vänsterhänt H. Högerhänt>",
    /* BoostEnabled              */
    "Aktivera främre knappen för turboläge (temperaturhöjning) vid lödning",
    /* BoostTemperature          */ "Temperatur i \\" turbo\\"-läge",
    /* AutoStart                 */
    "Startar automatiskt lödpennan vid uppstart. T=Lödning, S=Viloläge, F=Av",
    /* CooldownBlink             */
    "Blinka temperaturen medan spetsen kyls av och fortfarande är varm.",
...
const char* SettingsDescriptions[] = {
    ...
    /* MotionSensitivity         */
    "Hareket Hassasiyeti <0.Kapalı 1.En az duyarlı 9.En duyarlı>",
    /* TemperatureUnit           */ "Sıcaklık Ünitesi <C=Celsius F=Fahrenheit>",
    /* AdvancedIdle              */
    "Boş ekranda ayrıntılı bilgileri daha küçük bir yazı tipi ile göster.",
    /* DisplayRotation           */
    "Görüntü Yönlendirme <A. Otomatik L. Solak R. Sağlak>",
    /* BoostEnabled              */
    "Lehimleme yaparken ön tuşa basmak Boost moduna sokar(450C)",
    /* BoostTemperature          */ "\"boost\" Modu Derecesi",
    /* AutoStart                 */
    "Güç verildiğinde otomatik olarak lehimleme modunda başlat. T=Lehimleme "
    "Modu, S= Uyku Modu,F=Kapalı",
    /* CooldownBlink             */
    "Soğutma ekranında uç hala sıcakken derece yanıp sönsün.",
    /* TemperatureCalibration    */ "Ucu kalibre et.",
    /* SettingsReset             */ "Bütün ayarları sıfırla",
    /* VoltageCalibration        */
    "VIN Kalibrasyonu. Düğmeler ayarlar, çıkmak için uzun bas.",
...
const char* SettingsDescriptions[] = {
    /* PowerSource               */
    "Установка напруги відключення. <DC - 10V, 3S - 9.9V, 4S - 13.2V, 5S - "
    "16.5V, 6S - 19.8V>",
    /* SleepTemperature          */ "Температура режиму очікування <C°/F°>",
    /* SleepTimeout              */
    "Час до переходу в режим очікування <Доступно отключение>",
    /* ShutdownTimeout           */ "Час до відключення <Доступно відключення>",
    /* MotionSensitivity         */
    "Акселерометр <0 - Викл. 1 хв. чутливості 9 - макс. чутливості>",
    /* TemperatureUnit           */
    "Одиниця виміру температури <C - Цельсій, F - Фаренгейт>",
    /* AdvancedIdle              */
    "Показувати детальну в режимі налаштувань <Замість картинки>",
    /* DisplayRotation           */
    "Орієнтація дисплея <A - Автоповорот, L - Лівша, R - Правша>",
    /* BoostEnabled              */
    "Турбо-режим при утриманні кнопки А при пайці",
    /* BoostTemperature          */ "Температура в Турбо-режимі",
    /* AutoStart                 */
    "Автоматичний перехід в режим пайки при включенні живлення.",
    /* CooldownBlink             */
    "Показувати температуру на екрані охолодження, поки жало залишається "
    "гарячим, при цьому екран моргає",
    /* TemperatureCalibration    */ "Калібрування температурного датчика.",
    /* SettingsReset             */
    "Скидання всіх параметрів до вихідних значень.",
    /* VoltageCalibration        */
    "Калібрування напруги входу. Налаштувати кнопками, натиснути і утримати "
    "щоб завершити.",
...
const char* SettingsCalibrationWarning =
    "Переконайтеся, що жало охололо до кімнатної температури, перш ніж "
    "продовжувати!";
const char* SettingsResetWarning =
    "Ви дійсно хочете скинути налаштування до значень за замовчуванням?";
const char* UVLOWarningString = "АККУМ--";
